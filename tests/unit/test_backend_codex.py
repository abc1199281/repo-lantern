...
class TestCodexAdapter:
    ...
    def test_analyze_batch_success(self, mock_run: MagicMock, adapter: CodexAdapter) -> None:
...
"""
    ...
    @patch("subprocess.run")
    def test_analyze_batch_timeout(self, mock_run: MagicMock, adapter: CodexAdapter) -> None:
    ...
    @patch("subprocess.run")
    def test_analyze_batch_failure(self, mock_run: MagicMock, adapter: CodexAdapter) -> None:
